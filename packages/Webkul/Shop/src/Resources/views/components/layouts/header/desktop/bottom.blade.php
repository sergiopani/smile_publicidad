    ...
    <div class="flex gap-x-[35px] items-center max-lg:gap-x-[30px] max-[1100px]:gap-x-[25px]">
        ...
        <div class="flex gap-x-[35px] items-center max-lg:gap-x-[30px] max-[1100px]:gap-x-[25px]">
            <a
                ...
                class="text-[16px] font-medium text-[#6E6E6E] hover:text-navyBlue"
            >
            @lang('shop::app.components.layouts.header.publicity_link')
            </a>

            <a
                href="{{ route('shop.cms.page', 'contact') }}"
                class="text-[16px] font-medium text-[#6E6E6E] hover:text-navyBlue"
            >
            @lang('shop::app.components.layouts.header.web_link')
            </a>
        </div>
        {{-- Search Bar Container --}}
        <form
            action="{{ route('shop.search.index') }}"
            class="flex items-center max-w-[500px]"
            style="width: 450px;"
        >
            <label
                for="organic-search"
